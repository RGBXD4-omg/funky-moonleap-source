...
class Paths
{
	...
	inline static public function voices(song:String, fileName:String = 'Voices'):Any
	{
		var songKey:String = '${CoolUtil.spaceToDash(song.toLowerCase())}/$fileName';
		var voices = returnSound('songs', songKey);
		return voices;
	}

	inline static public function inst(song:String, fileName:String = 'Inst'):Any
	{
		var songKey:String = '${CoolUtil.spaceToDash(song.toLowerCase())}/$fileName';
